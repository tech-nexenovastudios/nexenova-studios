...
export function Navigation({ onNavigateHome, onNavigateAdmin }: NavigationProps) {
  ...
  const scrollToSection = (href: string) => {
    // Если мы не на главной странице, сначала навигируемся на главную
    const currentPath = window.location.pathname
    const currentHash = window.location.hash
    
    if (currentPath !== '/' || (currentHash && !currentHash.startsWith('#home'))) {
      onNavigateHome()
      // Ждем навигации, затем скроллим
      setTimeout(() => {
