  ...
  return (
    <Layout>
      <div className="legal-content">
        ...
        <p>
          Nexenova Studios builds mobile games as Freemium games. This SERVICE is 
          provided by Nexenova Studios at no cost and is intended for use as is.
        </p>
        ...
        <p>
          ...
          Conditions, which is accessible at our games unless otherwise defined in this 
          Privacy Policy.
        </p>
        ...
        <p>
          ...
          in the game we collect data and information (through third party products) on 
          ...
          the configuration of the game when utilizing our Service, the time and date of 
        ...
        <p>
          This Service does not use these "cookies" explicitly. However, the game may use 
          ...
          know when a cookie is being sent to your device. If you choose to refuse our cookies, 
