...
type Mode = 'form' | 'verify' | 'cancel'
type TokenState = 'loading' | 'ok' | 'error'

/** Reads ?action=verify|cancel&token=... once, at module eval per render. */
  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        {mode !== 'form' && <TokenAction mode={mode} token={token} onDone={onNavigateHome} />}
      </div>
    </div>
  )
}
